"""Shared payload builders + FastAPI router helpers.

Originally a self-contained WSGI prototype; the WSGI dispatch layer was retired
on 2026-05-16. The remaining contents are reused by ``apps/api/app/routers/*``
under uvicorn (``make api-dev``).
"""
