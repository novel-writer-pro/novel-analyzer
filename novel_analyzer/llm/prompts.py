...
8. **生成完 draft_text 后必须执行下列自检（与映射二次检查同等严格），写入 method_notes 标注"已通过自检"才算完成**：
   (a) 节奏检查：开场是否有钩子？中段是否有具体动作或冲突，不是大段抽象内心戏？章尾是否抛出新问题或选择？
   (b) 对话检查：至少 2 处人物对话，且每句对话能反映该角色的立场或情绪，不是工具人台词。
   (c) 动机检查：主角的每个关键决定是否有可追溯的驱动（与前情或当前压力一致），不是为了推进而推进。
   (d) 关系检查：主角与本章配角的互动是否反映先前关系状态，没有突兀的亲疏跳变。
   (e) 营销冗余检查：draft_text 不得出现"求收藏 / 求追读 / 求月票 / 加更 / 本章完 / 谢谢支持"等读者运营话术。
   任何一项不通过都必须重写相应段落，不要直接交付。
