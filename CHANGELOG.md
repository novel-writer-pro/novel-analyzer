...
### Changed (rag_core embedding norm adoption - 2026-05-23)
- rag_core/vector.py: introduced a shared embedding norm helper for reusable dense-vector math
- novel_analyzer/services/retrieval_service.py: switched local embedding norm calculation to reuse the shared rag_core helper
- tests/test_rag_core_contracts.py: extended TDD coverage to prove RetrievalService now uses the shared embedding norm helper
- docs/qa_upgrade_v2/12-phase-delivery-log.md: updated the reusable RAG core extraction phase with the shared embedding norm step
- docs/qa_upgrade_v2/15-audit-and-change-log.md: recorded the embedding norm extraction step and verification trail
- docs/handoffs/qa-upgrade-v2-handoff-20260522.md: updated code-extraction status with shared embedding norm
...
- tests/test_rag_core_contracts.py: extended TDD coverage to prove RetrievalService now uses the shared cosine helper
- docs/qa_upgrade_v2/12-phase-delivery-log.md: updated the reusable RAG core extraction phase with the new shared vector helper
- docs/qa_upgrade_v2/15-audit-and-change-log.md: recorded the ninth extraction step and verification trail
- docs/handoffs/qa-upgrade-v2-handoff-20260522.md: updated code-extraction status with shared cosine similarity
...
- docs/qa_upgrade_v2/03-roadmap.md: revised P2 wording to stabilize core retrieval before optional graph integration
- docs/qa_upgrade_v2/08-schema-and-contracts.md: clarified that core contracts should not assume graph is always present
- docs/qa_upgrade_v2/09-implementation-spec.md: updated implementation order so core retrieval works without graph before graph routes are layered in
- docs/qa_upgrade_v2/15-audit-and-change-log.md: recorded the reusable-core / optional-graph architecture decision
- docs/handoffs/qa-upgrade-v2-handoff-20260522.md: extended next-owner guidance with the new decoupling direction
