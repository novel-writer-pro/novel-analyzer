...
- 单章 LLM 调用：**5 → 3 次**（stage merging），单章延迟 **-40%**，整书吞吐 **+30%**
...
- ❌ "AI 自动写小说" / "替代编辑" / "判断好不好看"

## 深入

[capabilities/01-deconstruction.md](../../capabilities/01-deconstruction.md) · [deconstruction-acceleration/architecture.md](../../deconstruction-acceleration/architecture.md) · [foundation-optimization/README.md](../../foundation-optimization/README.md)
